...
use App\Enums\government_level;
...
return [
    ...
    custom_reports::class => [
        ...
        custom_reports::Agreement => 'Convenios',
    ],
    ...
    government_level::class => [
        government_level::State => 'Estatal',
        government_level::Federal => 'Federal',
        government_level::Municipal => 'Municipal'
    ]
];
