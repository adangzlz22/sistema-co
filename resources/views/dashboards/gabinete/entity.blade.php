        ...
        <div class="col-12">
            <div class="card card-body">
                ...
                <div class="row g-1">
                    ...
                    @switch(Auth::user()->entity->entities_type->name)
                        @case(\App\Models\Entity::DEPENDENCIA)
                            <div class="col-md-12">
                                <div class="card card-body">
                    
                                    <h5 class="mb-1 text-center">{{Auth::user()->entity->name}}</h5>
                                    @if($data["dep"]=="null")
                                        <div class="alert alert-info">
                                            <i class="mdi mdi-information-outline mdi-24px"></i>
                                            No se cuenta con información para mostrar.
                            ...
                            @break
                        @case(\App\Models\Entity::ENTIDAD)
                            <div class="col-md-12">
                                <div class="card card-body">
                            ...
                            @break
                        @case(\App\Models\Entity::ORGANISMO)
                            <div class="col-md-12">
                                <div class="card card-body">
                            ...
                            @break
                        @case(\App\Models\Entity::FIDEICOMISO)
                            <div class="col-md-12">
                                <div class="card card-body">
