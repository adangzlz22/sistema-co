...
{
    use HasFactory;
    static $system_catalogue = system_catalogues::EntitiesTypes;
    ...
    public static function _create(EntitiesType $model)
    {
        try{
    ...
    public static function _edit(EntitiesType $model)
    {
        try{
            $model->update();
